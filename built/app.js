...
(function (GameState) {
    ...
    GameState[GameState["Celebration"] = 2] = "Celebration";
})(GameState || (GameState = {}));
var GamePiece;
(function (GamePiece) {
    GamePiece[GamePiece["CUADRADO"] = 0] = "CUADRADO";
    GamePiece[GamePiece["CIRCULO"] = 1] = "CIRCULO";
})(GamePiece || (GamePiece = {}));
/**
...
class TicTacToe {
                        ...
                        switch (this.gameState) {
                            ...
                            case GameState.Play:
                                ...
                                if (this.boardState[tileIndexX * 3 + tileIndexZ] === undefined) {
                                    ...
                                    const gamePiecePosition = new MRE.Vector3(cube.transform.local.position.x, cube.transform.local.position.y + 0.55, cube.transform.local.position.z);
    ...
    beginGameStateCelebration(winner) {
